...
KEY_SKIP_TURN = Setting("skip turn", "SKIP", [pygame.K_RETURN, pygame.K_SPACE], cleaner=clean_keys)

KEY_INVENTORY = Setting("inventory", "INVENTORY", [pygame.K_r, pygame.K_i], cleaner=clean_keys)
